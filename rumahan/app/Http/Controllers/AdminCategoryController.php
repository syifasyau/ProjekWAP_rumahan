...
class AdminCategoryController extends Controller
{
    ...
    {
        $slug = SlugService::createSlug(Category::class, 'slug', $request->name); //create slug, ambil dari class post, ngambil field slug, judulnya ambil dari request  yg key nnya judul
